...
describe("LocationInput Component", () => {
  test("renders latitude and longitude inputs", () => {
    const { container } = render(<LocationInput onLocationChange={vi.fn()} />);
  ...
  test("validates latitude input", () => {
    ...
    const { container, getByRole } = render(<LocationInput onLocationChange={handleLocationChange} />);
  ...
  test("calls onLocationChange with valid latitude and longitude", () => {
    const handleLocationChange = vi.fn();
    const { container } = render(<LocationInput onLocationChange={handleLocationChange} />);
